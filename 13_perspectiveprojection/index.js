...
function initVetexBuffers(gl){
    ...
    var verticesColor = new Float32Array([
        ...
        0.75, 1.0, -4.0, 0.4, 1.0, 0.4,// in the back
        0.25, -1.0, -4.0, 0.4, 1.0, 0.4,
        1.25, -1.0, -4.0, 1.0, 0.4, 0.4,

        0.75, 1.0, -2.0, 1.0, 1.0, 0.4,// in the middle
        0.25, -1.0, -2.0, 1.0, 1.0, 0.4,
        1.25, -1.0, -2.0, 1.0, 0.4, 0.4,

        0.75, 1.0, 0.0, 0.4, 0.4, 1.0,// in the front
        0.25, -1.0, 0.0, 0.4, 0.4, 1.0,
        1.25, -1.0, 0.0, 1.0, 0.4, 0.4,

        // three triangles form the left
        -0.75, 1.0, -4.0, 0.4, 1.0, 0.4,// in the back
...
function draw(){
    ...
    rotationMatrix.lookAt(cameraPos, new THREE.Vector3(0, 0, -100), new THREE.Vector3(0, 1, 0));
